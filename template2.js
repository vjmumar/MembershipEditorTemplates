 import "https://kit.fontawesome.com/91a03c8b1f.js";
    ...
    class CourseTemplate {
        ...
        widgets = {
            ...
            heroBanner: (title = "Welcome to Flix Dummy 1", subtitle = "[Dummy ANYWHERE, ANYTIME].", paragraphHTML = "", embedHTML = "") => {
                const defaultEmbed = `<iframe width="560" height="315" src="https://www.youtube.com/embed/vbxqAV70KfY?si=xG02jkevHoLFc5vY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>`;
