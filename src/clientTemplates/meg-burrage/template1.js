         ...
         const html = `
                    <div class="template-sidebar">
                        <div class="template-sidebar__content">
                            ...
                            <a href="${this.isMobile ? "#" : "/categories"}" class='template-sidebar__titles'>Modules</a>
