         ...
         const html = `
                    <div class="template-hero" ${additionalInlineStyling ? `style='${additionalInlineStyling}'` : ""}>
                        ...
                        <div class="template-hero__right">
                            ...
                            ${`
                        <video id="myVideo" src="https://www.w3schools.com/html/mov_bbb.mp4" playsinline="" controls="" poster="https://peach.blender.org/wp-content/uploads/title_anouncement.jpg">
                               </video>
                              `} 
                        </div>
                    </div>
