               ...
               features: [
                  {
                     ...
                     cleanUpJs: (customizations = []) => {
                        let js = `
                        (() => {
                            const defaultLinks = [ { text: 'Home', url: '/' }, { text: "Library", url: "/courses/library-v2" }, { text: 'Favorites', url: '/favorites' }, { text: 'Announcements', url: '/announcements' }, { text: 'Pilates', url: '/pilates' }, { text: 'Contact', url: '/contact' } ];
