...
class CourseTemplate {
   ...
   initializers = {
      ...
      initStyles: () => {
         ...
         const styles = `<style id=template-global-styles>@import url(https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Quicksand:wght@300..700&display=swap);*{font-family:Quicksand,sans-serif}</style><style id=template-widget-styles>.template-welcome{background:#f7eae7;padding:12px 30px;display:flex;align-items:center;justify-content:space-between;color:#333;font-family:Poppins,sans-serif;box-shadow:0 2px 4px rgba(0,0,0,.05)}.template-welcome__left{display:flex;flex-direction:column;gap:5px}.template-welcome__greeting{font-size:20px;font-weight:600;line-height:24px;margin:0;color:#000}.template-welcome__progress{font-size:10px;line-height:15px;color:#000;font-weight:600;letter-spacing:1px;margin:0;display:flex;align-items:center;gap:5px}.template-welcome__progress-icon{color:#000;font-size:16px}.template-welcome__button{background:#4e3737;color:#aac5c5;padding:5px 40px;border-radius:4px;text-decoration:none;font-weight:600;font-size:18px;line-height:27px;box-shadow:0 5px 10px 0 rgba(0,0,0,.2);cursor:pointer;border:none}.template-hero{display:grid;grid-template-columns:1fr 1fr;gap:30px;width:100%;align-items:stretch;margin:0 auto}.template-hero__left{display:flex;flex-direction:column;height:100%;padding:20px;background-color:#fff}.template-hero__title{font-size:42px;font-weight:900;line-height:58.8px;color:#e1c4ba;margin-bottom:9px}.template-hero__subtitle{font-size:18px;font-weight:500;list-style:27px;color:#34495e;margin-bottom:25px;display:block}.template-hero__paragraph{font-size:16px;line-height:1.6;margin-bottom:15px}.template-hero__right{position:relative;padding-bottom:56.25%;height:0;overflow:hidden;border-radius:8px;box-shadow:0 4px 12px rgba(0,0,0,.1)}.template-hero__right iframe{position:absolute;top:0;left:0;width:100%;height:100%;border:0}.template-categories{padding-top:40px}.template-categories__title{font-size:32px;font-weight:700;color:#333;margin-bottom:25px}.template-categories__grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}.template-categories__card{background-color:#f7eae7;box-sizing:border-box;box-shadow:0 10px 12px 0 rgba(0,0,0,.1);display:flex;flex-direction:column;align-items:center;justify-content:space-between;height:100%;border-radius:4px;overflow:hidden;transition:transform .5s}.template-categories__card:hover{transform:scale(1.06)}.template-categories__thumbnail{width:100%;height:310px;object-fit:cover;display:block;border-radius:4px 4px 0 0}.template-categories__info{background-color:#f7eae7;color:#2c3e50;font-size:18px;line-height:1.3;flex-grow:1;width:100%;text-align:center;display:flex;justify-content:center;align-items:center;padding:10px 20px;box-sizing:border-box;word-wrap:break-word;overflow-wrap:break-word;margin-bottom:0;border-radius:0 0 4px 4px}.template-post{padding-top:40px}.template-post__title{font-size:32px;font-weight:700;color:#333;margin-bottom:25px}.template-post__grid{display:grid;grid-template-columns:repeat(3,1fr);gap:20px}.template-post__card{background-color:#f7eae7;box-sizing:border-box;box-shadow:0 10px 12px 0 rgba(0,0,0,.1);display:flex;flex-direction:column;align-items:center;justify-content:space-between;height:100%;border-radius:4px;overflow:hidden;transition:transform .5s}.template-post__card:hover{transform:scale(1.06)}.template-post__thumbnail{width:100%;height:310px;object-fit:cover;display:block;border-radius:4px 4px 0 0}.template-post__info{background-color:#f7eae7;flex-grow:1;width:100%;text-align:center;display:flex;justify-content:center;align-items:center;padding:10px 20px;box-sizing:border-box;word-wrap:break-word;overflow-wrap:break-word;margin-bottom:0;border-radius:0 0 4px 4px;font-size:16px;line-height:20px;color:#2c3e50;font-weight:700}.template-community-container{padding-top:0;padding-bottom:15px}.template-community-toggle{display:flex;justify-content:flex-end;width:100%}.template-community-toggle__button{background:#e1c4ba;box-shadow:0 3px 15px 0 rgba(0,0,0,.15);padding:6.75px 13.5px;font-size:18px;border-radius:.25rem;color:#000;width:fit-content}.template-community-embed{transition:max-height .5s ease-out,padding .5s ease-out;background:#fff;border:1px solid #eee;border-radius:6px;box-shadow:0 2px 8px rgba(0,0,0,.05);margin-top:10px;display:none;padding:20px}.template-community-container.active .template-community-embed{display:block}.template-community-embed form,.template-community-embed iframe{width:100%;height:100%;min-height:350px;border:none}.template-downloads{position:relative;width:100%;max-width:300px;font-family:Inter,sans-serif}.template-downloads__button{--download-text-color:#2b3c4d;--download-dropdown-bg:white;--download-dropdown-border-color:#e5e7eb;--download-dropdown-box-shadow:0 4px 6px -1px rgba(0, 0, 0, 0.1);--download-dropdown-item-icon-color:#9ca3af;--download-dropdown-item-text-color:#374151;display:flex;justify-content:flex-start;align-items:center;width:100%;cursor:pointer;font-size:16px;padding:8px 10px;border-radius:4px;border:1px solid #2b3c4d;color:var(--download-text-color);font-weight:700;position:relative;opacity:.5;transition:opacity .3s,background-color .3s,border-color .3s;background-color:transparent;box-shadow:none}.template-downloads.active .template-downloads__button{opacity:1!important}.template-downloads--active .template-downloads__button,.template-downloads__button:hover{opacity:1}.template-downloads__button i{color:var(--download-text-color)}.template-downloads__label{margin-left:.5rem;flex-grow:1;text-align:left}.template-downloads__icon-arrow{transition:transform .2s;margin-left:auto}.template-downloads--active .template-downloads__icon-arrow{transform:rotate(180deg)}.template-downloads__menu{position:absolute;top:calc(100% + 5px);left:0;right:0;background-color:var(--download-dropdown-bg);border:1px solid var(--download-dropdown-border-color);border-radius:.5rem;z-index:20;list-style:none;padding:0;margin:0;overflow:hidden;box-shadow:var(--download-dropdown-box-shadow);max-height:0;opacity:0;visibility:hidden;transform:translateY(-10px);transition:max-height .3s ease-out,opacity .3s ease-out,transform .3s ease-out}.template-downloads.active .template-downloads__menu{max-height:200px;opacity:1;visibility:visible;transform:translateY(0)}.template-downloads__item{padding:0}.template-downloads__item a{display:flex;align-items:center;padding:.5rem 1rem;color:var(--download-dropdown-item-text-color);text-decoration:none;transition:background-color .15s}.template-downloads__item a i{margin-right:.75rem;color:var(--download-driodown-item-icon-color)!important}</style><style id=template-styles>.template-sidebar{position:fixed;height:100vh;left:-290px;z-index:999999;transition-duration:.5s}.template-sidebar.active{left:0;transition-duration:.5s}.template-sidebar__content{width:290px;top:0;max-width:290px;background:#f7eae7;box-shadow:2px 0 5px 0 rgba(0,0,0,.05);overflow-y:auto;height:100vh;align-self:flex-start}.template-sidebar__back-button{display:flex;align-items:center;gap:7px;padding:25px 30px 0;color:#000}.template-sidebar__back-button__icon{padding-bottom:1px}.template-sidebar__back-button__text{font-size:11px;text-transform:uppercase;letter-spacing:1px;font-weight:600}.template-sidebar__logo{margin:auto;padding-inline:30px;padding-block:30px;min-width:252px}.template-sidebar__titles{font-size:16px;color:#34495e;font-weight:700;padding:5px 7px 5px 10px;cursor:pointer;background-color:transparent;border-bottom:solid #fff;border-top:solid #fff;line-height:22.4px}.template-sidebar__category__item__title{color:#34495e;font-weight:400;margin-top:0;margin-bottom:0;padding:5px 10px;cursor:pointer;background-color:#e1c4ba4d;border-bottom:solid #fff;display:flex;align-items:flex-start;justify-content:space-between;cursor:pointer;border-bottom-style:solid}.template-sidebar__category__item__title__content{display:flex;align-items:flex-start}.template-sidebar__category__item__title__content__icon{font-size:16px;transition-duration:.5s}.template-sidebar__category__item.active .template-sidebar__category__item__title__content__icon{transform:rotate(90deg);transition-duration:.5s}.template-sidebar__category__item__title__content__title{font-size:16px;font-weight:600;line-height:22.4px;margin-left:10px;color:#34495e}.template-sidebar__category__item__title__link i{font-size:16px;padding-top:3px}.template-sidebar__category__item.active .template-sidebar__category__item__content{display:block}.template-sidebar__category__item__content{display:none}.template-sidebar__category__item__post{display:flex;gap:10px;align-items:flex-start;cursor:pointer;margin:5px 20px 5px 25px}.template-sidebar__category__item__post__icon{width:15px;height:15px;color:#000;padding-top:3px}.template-sidebar__category__item__post__text{color:rgba(52,73,94,.8);display:block;font-size:15px;line-height:21px;padding-bottom:3px}.template-sidebar__category__item__sub-folder{margin-block:5px}.template-sidebar__category__item__sub-folder__title{display:flex;align-items:center;cursor:pointer;width:100%;justify-content:space-between;padding-left:20px;padding-right:10px}.template-sidebar__category__item__sub-folder__title__icon{font-weight:900;font-size:16px}.template-sidebar__category__item__sub-folder__title__text{font-size:15px;line-height:21px;color:#34495e;font-weight:700;padding:4px 12px 0 0}.template-sidebar__category__item__sub-folder.active .template-sidebar-category__item__sub-folder__posts{display:block}.template-sidebar-category__item__sub-folder__posts{padding-left:2px;display:none}.template-sidebar__image{display:block;border:.8px solid #97b1b1;border-radius:0;box-shadow:0 5px 10px 0 rgb(0 0 0 / 5%);background:#ecf0f1;padding:20px}.template-sidebar__image img{border-radius:8px}.template-sidebar__toggler{padding-inline:6px;background-color:#e1c4ba;position:absolute;top:0;right:-40px;display:flex;align-items:center;justify-content:center;flex-direction:column;cursor:pointer;transition:all .2s ease-in-out;width:40px;height:100vh}.template-sidebar__toggler:hover{transition:all .2s ease-in-out}.template-sidebar__toggler i{color:#fff;font-size:18px;font-family:var(--_fa-family)!important}.template-sidebar__toggler i.close{display:none}.template-sidebar.active .template-sidebar__toggler .close{display:block}.template-sidebar.active .template-sidebar__toggler .open{display:none}.template-navbar-wrapper{background-image:url(https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2160086492/settings_images/3a2e6eb-114a-16ac-8c6a-3e48adacfe5d_Square_Image_Block_Template_4.jpg);background-size:cover;position:relative;display:flex;align-items:center;justify-content:space-between;padding-block:30px;padding-inline:15px}.template-navbar-wrapper *{z-index:1;position:relative}.template-navbar-wrapper::before{content:"";position:absolute;width:100%;height:100%;background-color:#ffffffbf;left:0;top:0;z-index:0}.template-navbar__logo-link img{margin-left:50px;max-height:100px}.template-navbar__content{display:flex;align-items:center;gap:18px}.template-navbar__content__close{display:none}.template-navbar__content__nav-links{display:flex;align-items:center;gap:20px}.template-navbar__content__nav-links a{font-size:18px;line-height:100px;font-weight:400}.template-navbar__content__avatar-img{height:40px;margin-right:20px;border-radius:50%}.template-navbar__burgermenu{display:none}.page-dashboard .product-container{width:calc(100% - 40px);margin-left:auto;min-height:100vh}.dashboard__wrapper{padding:50px 75px;min-height:100vh;position:relative;background-attachment:fixed;background-position:center;background-size:cover;background-image:url(https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2160127427/settings_images/1d2d445-3de6-711-008c-2a0de02bfc5e_Copy_of_Hero_Background_Image_Template_2880_x_1600px_1_.png);--dashboard-overlay-bg:white;--dashboard-overlay-opacity:0.8}.dashboard__wrapper::before{content:"";position:absolute;width:100%;height:100%;background-color:var(--dashboard-overlay-bg);opacity:var(--dashboard-overlay-opacity);left:0;top:0;z-index:0}.dashboard__wrapper *{z-index:1;position:relative}.dashboard__categories{margin-top:30px}.dashboard__categories__title{padding:20px 40px 0;color:#2c3e50;font-size:31.5px;line-height:44.1px;font-weight:600}.page-category-posts #app-container{width:calc(100% - 40px);margin-left:auto}.template-category-post-title{background:#f7eae7;box-shadow:0 5px 10px 0 rgba(0,0,0,.05);padding:20px 50px;font-size:30px;line-height:42px;font-weight:700;text-align:center;color:#2b3c4d}.template-category-post{background-color:#e8f0f1;padding:50px;min-height:100vh;position:relative;background-attachment:fixed;background-position:center;background-size:cover;background-image:url(https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2160127427/settings_images/1d2d445-3de6-711-008c-2a0de02bfc5e_Copy_of_Hero_Background_Image_Template_2880_x_1600px_1_.png);--category-post-overlay-bg:white;--category-post-overlay-opacity:0.8}.template-category-post *{z-index:1;position:relative}.template-category-post::before{content:"";position:absolute;width:100%;height:100%;background-color:var(--category-post-overlay-bg);opacity:var(--category-post-overlay-opacity);left:0;top:0;z-index:0}.template-category-post__breadcrumbs{display:flex;justify-content:center;align-items:center;gap:5px;color:#2c3e50;font-size:12px;line-height:18px;font-weight:400}.template-category-post__sub-categories__item{margin-top:40px}.template-category-post__sub-categories__item__title{font-size:30px;font-weight:700}.template-category-post__sub-categories__item .template-post{padding-top:20px}.page-categories #app-container{width:calc(100% - 40px);margin-left:auto}.template-categories-title{background:#f7eae7;box-shadow:0 5px 10px 0 rgba(0,0,0,.05);padding:20px 50px;font-size:30px;line-height:42px;font-weight:700;text-align:center;color:#2b3c4d}.template-categories__list{background-color:#e8f0f1;padding:50px;min-height:100vh;position:relative;background-attachment:fixed;background-position:center;background-size:cover;background-image:url(https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/themes/2160127427/settings_images/1d2d445-3de6-711-008c-2a0de02bfc5e_Copy_of_Hero_Background_Image_Template_2880_x_1600px_1_.png);--categories-overlay-bg:white;--categories-overlay-opacity:0.8}.template-categories__list *{z-index:1;position:relative}.template-categories__list::before{content:"";position:absolute;width:100%;height:100%;background-color:#ecf2f2e6;left:0;top:0;z-index:0;background-color:var(--categories-overlay-bg);opacity:var(--categories-overlay-opacity)}.template-categories__sub-categories__item{margin-top:40px}.template-categories__sub-categories__item__title{font-size:33px;font-weight:700}.template-categories__sub-categories__item .template-post{padding-top:20px}.page-post #app-container{width:calc(100% - 40px);margin-left:auto}.template-post-page-header{background:#f7eae7;box-shadow:0 5px 10px 0 rgba(0,0,0,.05);padding:10px 50px;display:flex;align-items:center;justify-content:center;gap:10px}.template-post-page-header__mark-as-complete{font-size:16px;padding:8px 10px;border-radius:4px;border:1px solid #2b3c4d;color:#2b3c4d;font-weight:700;opacity:.5;cursor:pointer;transition-duration:.3s}.template-post-page-header__mark-as-complete:hover{transition-duration:.3s;opacity:1}.template-post-page-header__arrow{font-size:32px;opacity:.5;color:#2b3c4d!important;transition-duration:.3s;display:flex;align-items:center}.template-post-page-header__arrow.prev{rotate:180deg}.template-post-page-header__arrow:hover{opacity:1!important;transition-duration:.3s;text-decoration:none}.template-post-page{background-color:#e1c4ba3b;padding:50px;min-height:100vh;position:relative}.template-post-page__breadcrumbs{display:flex;justify-content:center;align-items:center;gap:5px;color:#2c3e50;font-size:12px;line-height:18px;font-weight:400}.template-post-page__title{font-size:45px;font-weight:600;text-align:center;margin-top:30px;margin-bottom:20px;color:#2b3c4d}.template-post-page__audio,.template-post-page__video{max-width:75%;margin-inline:auto}.template-post-page__description{max-width:60%;margin-inline:auto;margin-top:40px;margin-bottom:40px}.template-post-page__comments{max-width:60%;margin-inline:auto}@media (max-width:768px){.template-navbar-wrapper{padding:13px 10px}.template-navbar__logo-link img{margin:0;height:50px}.template-navbar__burgermenu{display:block;font-family:var(--_fa-family)!important;color:#000;font-size:25px}.template-navbar__content{position:fixed;width:90%;height:100vh;top:0;left:0;z-index:999999999999999;background-color:#e1c4ba;flex-direction:column-reverse;overflow-y:scroll;align-items:flex-start;padding:20px;justify-content:flex-end;box-shadow:0 0 0 50vw #00000054}.template-navbar__content__close{display:block;font-family:var(--_fa-family)!important;color:#000;font-size:25px}.template-navbar__content__nav-links{flex-direction:column;align-items:flex-start;margin-top:13px;gap:15px}.template-navbar__content__nav-links a{font-size:18px;line-height:25px}}</style>`;
