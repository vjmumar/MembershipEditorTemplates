...
class CourseTemplate {
   ...
   widgets = {
      initStyles: () => {
         const style = `<style id="template-widget-styles"></style>`;
         document.body.insertAdjacentHTML("afterbegin", styles);
      },
      welcomeBanner: (
         name = "User",
