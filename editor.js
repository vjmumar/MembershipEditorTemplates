   ...
   class MembershipCustomization {
         ...
         this.templates = [
            {
               id: "template-0",
               imageUrl:
                  "https://storage.googleapis.com/msgsndr/imyvHV2ppMPun9vEAcRz/media/69492d947614ce184f7e9b76.png",
               title: "Template 1",
               scriptLink:
                  "https://rawcdn.githack.com/vjmumar/MembershipEditorTemplates/f6015455d3728feb368bfbeb72c8bce01991d92d/template1.js",
               previewLink: "",
            },
            {
               id: "template-1",
               ...
               title: "Template 2",
               scriptLink:
                  "https://cdn.jsdelivr.net/gh/vjmumar/MembershipEditorTemplates@main/template2.js",
               previewLink: "",
            },
         ];
      ...
      initializers = {
         ...
         init: () => {
            ...
            const isEdit =
               new URLSearchParams(window.location.search).get("membershipeditor") ===
               "true";
         ...
         initializeEditor: () => {
            ...
            // Then we will initialize/show the global contents settings after a short delay
            setTimeout(() => {
               this.initializers.initializeGlobalContents();
            }, 500);
            ...
            window.addEventListener("click", (e) => {
               ...
               if (editableElement) {
                  ...
                  this.initializers.initializeElementEditor(
                     key,
                     "template1",
                     editableElement,
                  );
         ...
         initializeElementEditor: (
            ...
            const featuresHTML = templateItem?.features?.reduce((a, c) => {
               ...
               const toggleFeatureInlineJs = (() => {
                  if (isGlobal && globalName) {
                     return `window.MembershipCustomization.actions.toggleTemplateFeature({},{name: '${globalName}',templateItemKey: '${templateItem.key}',featureKey: '${c.key}',isTurnedOn: this.checked})`;
                  } else {
                     return `window.MembershipCustomization.actions.toggleTemplateFeature({templateItemKey: '${templateItem.key}',featureKey: '${c.key}',isTurnedOn: this.checked})`;
                  }
               })();
            ...
            const form = `
                    <div class="editor-customizer-header">
                        <i class="fa-solid fa-arrow-left editor-customizer-header__global" onclick="window.window.MembershipCustomization.initializers.initializeGlobalContents()"></i>
         ...
         initializeGlobalContents: () => {
            ...
            const globalItemsHTML = this.activeTemplate.global.reduce((a, c) => {
               ...
               a += `
                    <div class="global-contents-item">
            ...
            $sidebarContent.innerHTML = `
                <div class="global-contents">
                    <div class="global-contents__header">
                        ...
                        <i class="fa-solid fa-shirt global-contents__header__themes" onclick="window.MembershipCustomization.initializers.initializeThemeSelector()"></i> 
                    </div>
                    ${globalItemsHTML}
                </div>
            `;
            ...
            $sidebarContent.innerHTML = `
                <div class="theme-selector">
                    <div class="theme-selector__header">
                        <i class="fa-solid fa-arrow-left theme-selector__header__icon" onclick="window.MembershipCustomization.initializers.initializeGlobalContents()"></i>
