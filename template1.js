...
class CourseTemplate {
   ...
   mobileInitializers = {
      ...
      initStyles: () => {
         // !Note: Use https://unminify.com/ to uncompress the styles, and use https://www.textfixer.com/html/compress-html-compression.php to compress again
         const styles = `<style id="template-styles">/* Dashboard */ .page-dashboard .template-container { padding: 10px; } /* Post */ .page-post #app-container { width: 100%; max-width: calc(100% - 35px); margin-left: auto; } .template-post-page { background-color: #e1c4ba3b; padding: 30px 10px; min-height: 100vh; position: relative; } .template-post-page-header { background: #f7eae7; box-shadow: 0 5px 10px 0 rgba(0, 0, 0, 0.05); padding: 10px 50px; display: flex; align-items: center; justify-content: center; gap: 10px; } .template-post-page-header__mark-as-complete { font-size: 16px; padding: 8px 10px; border-radius: 4px; border: 1px solid #2b3c4d; color: #2b3c4d; font-weight: 700; opacity: 0.5; cursor: pointer; transition-duration: 0.3s; } .template-post-page-header__mark-as-complete:hover { transition-duration: 0.3s; opacity: 1; } .template-post-page-header__arrow { font-size: 32px; opacity: 0.5; color: #2b3c4d !important; transition-duration: 0.3s; display: flex; align-items: center; } .template-post-page-header__arrow.prev { rotate: 180deg; } .template-post-page-header__arrow:hover { opacity: 1 !important; transition-duration: 0.3s; text-decoration: none; } .template-post-page__breadcrumbs { display: flex; justify-content: center; align-items: center; gap: 5px; color: #2c3e50; font-size: 12px; line-height: 18px; font-weight: 400; } .template-post-page__title { font-size: 35px; font-weight: 600; text-align: center; margin-top: 30px; margin-bottom: 20px; color: #2b3c4d; } .template-post-page__video, .template-post-page__audio { max-width: 100%; margin-inline: auto; } .template-post-page__description { max-width: 100%; margin-inline: auto; margin-top: 40px; margin-bottom: 40px; } .template-post-page__comments { max-width: 100%; margin-inline: auto; } @media (max-width: 1024px) { /* Dashboard */ .page-dashboard .product-container { width: 100%; max-width: calc(100% - 35px); } /* Post */ .page-post #app-container { width: 100%; max-width: calc(100% - 35px); } /* Categories */ .page-categories #app-container { width: 100%; max-width: calc(100% - 35px); } /* Category Posts */ .page-category-posts #app-container { width: 100%; max-width: calc(100% - 35px); } .template-category-post__breadcrumbs { font-size: 13px; } .template-category-post { padding: 10px; } .template-categories-title { padding: 10px 15px; font-size: 23px; } .template-categories__list { padding: 10px; } }</style>`;
         document.body.insertAdjacentHTML("afterbegin", styles);
      },
