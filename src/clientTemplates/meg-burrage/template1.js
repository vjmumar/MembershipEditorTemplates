<style id="editor">
   ...
   .editor-customizer-sidebar select {
      font-size: 13px;
      padding: 5px 10px;
   ...
   .editor-customizer-category {
      display: flex;
      margin-bottom: 10px;
   }

   .editor-customizer-category__item {
      flex: 1;
      display: flex;
      align-items: center;
   ...
   .editor-customizer-category__item.active {
      border-color: #10b981;
   }
   ...
   .editor-customizer-item__form__item.active {
      display: block;
   }
   ...
   .editor-customizer-item__form__item__input__group__name {
      font-size: 11px;
   }
   ...
   .editor-customizer-item__form__item__input__group__toggler p {
      font-size: 13px;
   }
   ...
   .editor-customizer-item__form__item__input__group.feature.active
      .editor-customizer-item__form__item__input__group__name__toggler
      i {
   ...
   /* Customization Group */
   .editor-customizer-item__form__item__input__group__group {
      margin-bottom: 5px;
   }

   .editor-customizer-item__form__item__input__group__group__header {
      display: flex;
      justify-content: space-between;
      gap: 10px;
      background-color: #f0f0f0;
   ...
   .editor-customizer-item__form__item__input__group__group__header p {
      font-size: 12px;
   }

   .editor-customizer-item__form__item__input__group__group__header i {
      font-size: 9px;
   }

   .editor-customizer-item__form__item__input__group__group.active
      .editor-customizer-item__form__item__input__group__group__header
      i {
      transform: rotate(180deg);
   }

   .editor-customizer-item__form__item__input__group__group__contents {
   ...
   .editor-customizer-item__form__item__input__group__group__contents__controller {
      display: flex;
      gap: 5px;
      align-items: center;
      padding-bottom: 7px;
   ...
   .editor-customizer-item__form__item__input__group__group__contents__controller button {
      font-size: 13px;
      display: flex;
      align-items: center;
   }
   ...
   .global-contents__header__mobile-switch {
      font-size: 20px;
      color: black;
      cursor: pointer;
   }

   .global-contents__header__text {
      font-weight: 700;
      font-size: 14px;
      color: black;
   }

   .global-contents__header__control {
      background-color: #f0f0f0;
      padding: 8px 10px;
      border-radius: 5px;
      display: flex;
   ...
   .global-contents__header__control i {
      color: #000000;
      cursor: pointer;
   }

   .global-contents__header__control i.disabled {
      pointer-events: none;
      opacity: 0.5;
   }

   .global-contents__header__control::before {
      content: "";
      position: absolute;
      left: 0;
      right: 0;
   ...
   .global-contents__separator::before,
   .global-contents__separator::after {
      content: "";
      height: 0.5px;
      flex: 1;
   ...
   .global-contents-item.active .global-contents-item__toggler {
      border-bottom-left-radius: 0;
      border-bottom-right-radius: 0;
   }

   .global-contents-item__toggler p {
      font-size: 15px;
   }

   .global-contents-item__toggler i {
      font-size: 11px;
   }

   .global-contents-item.active .global-contents-item__toggler i {
      rotate: 90deg;
   }

   .global-contents-item__wrapper {
      padding: 10px;
   ...
   .global-contents-item.active .global-contents-item__wrapper {
      display: block;
   }

   .global-contents-item__item {
      margin-bottom: 5px;
   }

   .global-contents-item__item__title {
      display: flex;
      justify-content: space-between;
      align-items: center;
      cursor: pointer;
   ...
   .global-contents-item__item.active .global-contents-item__item__title {
      border-bottom-left-radius: 0;
      border-bottom-right-radius: 0;
   }

   .global-contents-item__item.active .global-contents-item__item__title i {
      rotate: 90deg;
   }

   .global-contents__additional-settings {
      display: flex;
      justify-content: space-between;
      align-items: center;
      background-color: #8080801f;
   ...
   .global-contents__additional-settings p {
      font-size: 15px;
   }

   .global-contents__additional-settings i {
      font-size: 11px;
   }
   ...
   .additional-settings-header__text {
      font-weight: 700;
      font-size: 14px;
      color: black;
   }

   .additional-settings-header__icon {
      font-size: 20px;
      color: black;
      cursor: pointer;
   }
   ...
   /* Advance settings */
   .advance-settings__thumbnail-placeholder {
      margin: 10px;
   }

   .advance-settings__thumbnail-placeholder__label {
      font-size: 13px;
      margin-bottom: 6px;
   }

   .advance-settings__thumbnail-placeholder__preview {
      width: 100%;
      height: 150px;
   ...
   .advance-settings__thumbnail-placeholder__info {
      font-size: 9px;
      margin-bottom: 9px;
   }

   .advance-settings__customcss {
      margin: 10px;
   }

   .advance-settings__customcss__label {
      font-size: 13px;
      margin-bottom: 6px;
   }

   .advance-settings__fonts {
      margin: 10px;
   }

   .advance-settings__fonts__label {
      font-size: 13px;
      margin-bottom: 6px;
   }

   .advance-settings__fonts__info {
      font-size: 9px;
   }

   /* Editable Pages */
   .editable-pages__list {
      display: flex;
      flex-direction: column;
      padding: 0 10px;
      gap: 8px;
   ...
   .editable-pages__list__item input {
   }

   .editable-pages__list__item p {
      font-size: 12px;
   }
   ...
   .widget-font-select__input::placeholder {
      color: #374151;
      font-weight: 500;
      font-size: 14px;
      text-align: left;
   ...
   .widget-font-select__input:focus {
      border-color: #3b82f6;
      box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1);
   }

   .widget-font-select__input--has-selection::placeholder {
      color: #374151;
      font-weight: 500;
      font-size: 14px;
      text-align: left;
   ...
   .widget-font-select__list p {
      font-size: 10px;
      padding-inline: 7px;
      padding-block: 5px;
   }

   .widget-font-select:focus-within .widget-font-select__list {
      display: block;
   }

   .widget-font-select__item {
      padding: 10px 12px;
      font-size: 13px;
      color: #374151;
      cursor: pointer;
   ...
   .widget-font-select__item:hover {
      background: #f3f4f6;
   }

   .widget-font-select__item--hidden {
      display: none;
   }
...
></script>
<script src="https://kit.fontawesome.com/d84a98056b.js"></script>
<script defer>
   class MembershipPreview {
      constructor() {
         this.isPreviewEditor = location.href.includes("isEditorPreview=true");
         if (this.isPreviewEditor) {
            setTimeout(() => {
      ...
      // Data module
      data = {
         // This helper method retrieve the editable pages name and url
      ...
      // Utils module
      utils = {
         // This helper method retrieves the auth information
         getAuth: async () => {
   ...
   class MembershipParser {
      constructor() {
         ...
         this.isEdit = location.href.includes("membershipeditor=true");
         this.isPreviewEditor = location.href.includes("isEditorPreview=true");
         this.isDesktop = window.matchMedia("(min-width: 768px)").matches;

         // Then we will check if we are in edit mode, we stop the constructor here to prevent redundant initialization.
         ...
         (async () => {
            ...
            const script = document.createElement("script");
            script.src = (
               currentTemplate ? currentTemplate : this.templates[0]
            )?.scriptLink;
            document.body.append(script);
            ...
            script.onload = () => {
               ...
               this.activeTemplate = (() => {
                  if (activeTemplateFromSavedTemplates?.id) {
                     if (
                        ...
                        /**
                         * First we will strip deprecated items from saved data before merging,
                         * using the master schema as the source of truth for valid keys.
                         */
                        const stripDeprecated = (masterObj, savedObj) => {
                           const result = window._.cloneDeep(savedObj);

                           Object.keys(result).forEach((key) => {
                              const masterVal = masterObj[key];
                              const savedVal = result[key];

                              if (Array.isArray(masterVal) && Array.isArray(savedVal)) {
                                 result[key] = savedVal.filter((savedItem) =>
                                    masterVal.some(
                                       (masterItem) =>
                                          savedItem.key === masterItem.key ||
                                          savedItem.property === masterItem.property,
                                    ),
                                 );
                              }
                           });
                        ...
                        const cleanedSaved = window._.cloneDeep(
                           activeTemplateFromSavedTemplates,
                        );

                        // Then we will strip deprecated items from each page's edit structure
                        if (
                           Array.isArray(cleanedSaved.pages) &&
                           Array.isArray(window.templateCustomizationSchema.pages)
                        ) {
                           cleanedSaved.pages = cleanedSaved.pages.map((savedPage) => {
                              const masterPage =
                                 window.templateCustomizationSchema.pages.find(
                                    (p) => p.key === savedPage.key,
                                 );
                              if (!masterPage) return savedPage;

                              if (
                                 Array.isArray(savedPage.editStructure) &&
                                 Array.isArray(masterPage.editStructure)
                              ) {
                                 savedPage.editStructure = savedPage.editStructure.map(
                                    (savedItem) => {
                                       const masterItem = masterPage.editStructure.find(
                                          (m) => m.key === savedItem.key,
                                       );
                                       if (!masterItem) return savedItem;
               ...
               // Then, we select the default page editor configuration based on the device type (Desktop or Mobile).
               this.activePageOnTemplate =
                  this.activeTemplate?.[
                     this.isDesktop ? "pages" : "mobilePages"
                  ][0]?.editor;
      ...
      initializers = {
         ...
         initSyncConfig: (immediateSync = false) => {
            ...
            this.activeTemplate?.[this.isDesktop ? "pages" : "mobilePages"]?.forEach(
               (page) => {
                  /**
                  ...
                  if (urlRegex?.test(url)) {
                     ...
                     /**
                      * Then we will delay feature customizations to ensure the DOM
                     ...
                     /**
                      * Finally we will initialize the membership preview after a short delay.
                      * This ensures all required elements and configurations are ready
                      * before activating preview mode
                      */
                     setTimeout(() => {
                        if (this.isPreviewEditor && !immediateSync) {
                           if (!window.MembershipPreview) {
   ...
   class MembershipEditor {
      constructor() {
         this.isEdit = location.href.includes("membershipeditor=true");
         this.isPreviewEditor = location.href.includes("isEditorPreview=true");
         this.isPagePreview = sessionStorage?.is_preview === "true";
         this.templateUndoStack = [];
         this.loadedGoogleFontsPreview = [];
      ...
      // Initializer module
      initializers = {
         // This method serves as the entry point for initializing the application.
         init: async () => {
            // First, check if the page is in preview mode; if not, exit the method.
            if (!this.isPagePreview) return;

            // Finally, determine if we need to launch the full Editor or just the toggle widget.
            if (this.isEdit) {
               // First, retrieve the main app and app-container elements.
               const $app = document.querySelector("#app");
               const $appContainer = await this.utils.waitForElement("#app-container", 0);

               // Then, generate and sanitize the URL for the preview.
               const url = new URL(location.href);
               url.searchParams.delete("isEditorPreview");
               url.searchParams.delete("membershipeditor");
               url.searchParams.append("isEditorPreview", "true");
               const cleanUrl = url.toString();

               // Then, clear the existing UI to make room for the iframe editor.
               if ($appContainer) $appContainer.remove();

               // Then, clear the template loader
               document.querySelector(".template-loader")?.remove();

               // Then, create an iframe to load the current page in edit mode and append it to the app.
               this.$iframe = document.createElement("iframe");
               this.$iframe.src = cleanUrl;
               this.$iframe.id = "membership-editor-iframe-preview";
               this.$iframe.style.cssText =
                  "width:100%; height:100vh; border:none; display:block; margin-inline: auto";
               $app.prepend(this.$iframe);

               // Then we will set the body overflow to hidden
               document.body.style.overflow = "hidden";

               // Finally, wait for the iframe's internal DOM to be ready before firing the editor logic.
               this.$iframe.onload = () => {
                  /**
                   * First we will check if the editor is already mounted in the current context.
                   * This can happen when re-initializing (e.g. switching between desktop and mobile modes).
                   */
                  const isEditorAlreadyInserted =
                     document.querySelector(".editor-customizer-sidebar") !== null;

                  /**
                   * Then we will decide which initializer to run:
                   * - If the editor already exists, we call initializeEditor to re-sync and update the current state
                   * - If not, we call initShowEditor to perform the full initialization flow
                   */
                  this.initializers?.[
                     isEditorAlreadyInserted ? "initializeEditor" : "initShowEditor"
                  ]();
               };
            } else {
               // Fallback: If in preview but not in edit mode, show the floating toggle (if not already present).
               if (!this.isPreviewEditor) {
         ...
         initFloatingWidgetToggler: () => {
            ...
            setTimeout(() => {
               document
                  .querySelector(".editor-floating-toggler")
         ...
         initializeEditor: () => {
            // First we will remove existing sidebar editor's
            document.querySelector(".editor-customizer-sidebar")?.remove();

            // Then, inject the customization sidebar HTML into the application container.
            const sidebarHTML = `
                <div class="editor-customizer-sidebar active">
                    <div class="editor-customizer-sidebar__content">
                        <div style="width: 100%; padding: 24px 16px;background: #f9f9f9;border-radius: 8px;border: 1px solid #eee;text-align: center;font-family: sans-serif;position: absolute;top: 0;height: 100%;z-index: 99999999;display: flex;flex-direction: column;align-items: center;">
                           <div style="margin: 0 auto 16px auto; width: 24px; height: 24px; border: 3px solid #ddd; border-top: 3px solid #000; border-radius: 50%; animation: spin 0.8s linear infinite;"></div>
                           <style>@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }</style>
                           <h3 style="margin: 0 0 8px 0; color: #000; font-size: 18px; font-weight: 600;">Please wait</h3>
            ...
            // Then, attach a click listener to the "Exit" button.
            setTimeout(() => {
               document
                  .querySelector(".editor-customizer-exit")
                  ?.addEventListener("click", () => {
            ...
            // Finally, attach the event listener for the "Save" button.
            setTimeout(() => {
               document
                  .querySelector(".editor-customizer-save")
         ...
         initializeElementEditor: (
            ...
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
               previewIframeMembershipParser.activePageOnTemplate;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;

            // Then we will retrieve the element
            const element = this.$iframe.contentDocument.querySelector(selector);

            // Then we will retrieve the sidebar and its content container
            ...
            // Then we will retrieve the specific template item data based on the clicked element's key or the global passed global name and key
            let templateItem = (() => {
               if (isGlobal && globalName) {
                  return activeTemplate.global
                     ?.find((item) => item.name === globalName)
                     ?.customizations?.find((item) => item.key === key);
               } else {
                  return activePageOnTemplate.find((item) => item.key === key);
               }
            })();
            ...
            const cssCustomizationHtml = templateItem.cssCustomizations.reduce((a, c) => {
               const input = (() => {
                  const propertyValue = (() => {
                     const computedStyleValue = element
                        ? this.$iframe?.contentWindow?.getComputedStyle(element)?.[
                             c.property
                          ]
                        : "";
                     return computedStyleValue?.replace(
                        /^url\(["']?(.*)["']?\)$/,
                        (match) => {
                  ...
                  if (c.type === "multi") {
                     return this?.widgets?.multiInput(
                        templateItem.key,
                        c?.property,
                        ...
                        (updatedValue) => {
                           ...
                           this.actions.updateTemplateCustomizations(...updateArgs);
                        },
                     );
                  } else if (c.type === "font") {
                     return this?.widgets?.fontSelect(
                        templateItem.key,
                        c?.property,
                        c?.value,
                        c?.type,
                        ...
                        (updatedValue) => {
                           ...
                           this.actions.updateTemplateCustomizations(...updateArgs);
                           if (updatedValue.type === "google") {
                              this.actions.pushFontGoogleFontsUsed(updatedValue.name);
                           }
                        },
                     );
                  } else if (c.type === "select") {
                     // First we will check if the type is either select or font, if font we will return the active tempaltes fonts else just the passed options
                     return this?.widgets?.select(
                        templateItem.key,
                        c.property,
                        c?.value || "",
                        c.type,
            ...
            const elementCustomizationHTML = templateItem?.elementCustomizations?.reduce(
               (a, c) => {
                  const input = (() => {
                     const value = (() => {
                        let elementValue = "";
                        if (c.type === "html") {
                           ...
                           const elementAttribute = element?.getAttribute(c?.target);
            ...
            const featuresHTML = templateItem?.features?.reduce((a, c) => {
               // First we will group the feature customizations
               const groupedCustomizations = c.customizations?.reduce((a, c) => {
                  if (c.group) {
                     if (c.groupLabel) {
                        a.push({
                           groupId: c.group,
                        ...
                        a.forEach((el) => {
                           if (el?.groupId === c.group) {
                              el.customizations.push(c);
                           }
                        });
                     }
                  } else {
               ...
               // Then we will build the inputs for this specific feature's customizations
               const customizationHTML = groupedCustomizations?.reduce((ac, cc) => {
                  // First we will create a function that generate the input of the customization
                  const generateInput = (customization = {}, isGroup = false) => {
                     return this?.widgets?.input(
                        templateItem.key,
                        `${customization?.type}-${customization?.property}`,
                        customization?.value,
                        customization.type,
                              ...
                              if (isGlobal && globalName) {
                                 return [
                                    {},
                                    {
                                       ...
                                       featureKey: c.key,
                                       customizationProperty: customization?.property,
                                       value: updatedValue,
                                    },
                                 ];
                              } else {
                  ...
                  // Finally we will append the html to accumulator
                  if (cc.groupId) {
                     const groupCustomizationsHTML = cc.customizations.reduce(
                        (aaa, ccc) => {
                           aaa += `
                              <div class="editor-customizer-item__form__item__input__group">
                                  <p class="editor-customizer-item__form__item__input__group__name">${ccc.name}</p>
                                  ${generateInput(ccc, true)}
                              </div>
                           `;
                           return aaa;
                        },
                     ...
                     const cancenButtonJs = `this.parentElement.parentElement.parentElement.classList.remove('active');delete window['${c.key}'];`;
                     const saveButtonJs = `Object.values(window['${c.key}'] || {}).forEach((inp) => window.MembershipEditor.actions.updateTemplateFeatureCustomizations(...inp));delete window['${c.key}'];this.parentElement.parentElement.parentElement.classList.remove('active');`;
                     ac += `
                              <div class="editor-customizer-item__form__item__input__group__group" data-feature-group="${cc.groupId}">
                                  <div class="editor-customizer-item__form__item__input__group__group__header" onclick="this.parentElement.classList.toggle('active')">
                                    <p>${cc.label}</p>  
                                    <i class="fa-solid fa-caret-down"></i>
                                  </div>
                                  <div class="editor-customizer-item__form__item__input__group__group__contents">
                                    ${groupCustomizationsHTML}
                                    <div class="editor-customizer-item__form__item__input__group__group__contents__controller">
                                       <button onclick="${cancenButtonJs}">Cancel</button>   
                                       <button onclick="${saveButtonJs}">Save</button>   
                                    </div>
                                  </div>
                              </div>
                          `;
               ...
               // Then we will generate the inline js for toggling the feature
               const toggleFeatureInlineJs = (() => {
                  if (isGlobal && globalName) {
                     return `window.MembershipEditor.actions.toggleTemplateFeature({},{name: '${globalName}',templateItemKey: '${templateItem.key}',featureKey: '${c.key}',isTurnedOn: this.checked})`;
                  } else {
                     return `window.MembershipEditor.actions.toggleTemplateFeature({templateItemKey: '${templateItem.key}',featureKey: '${c.key}',isTurnedOn: this.checked})`;
                  }
               })();
                       ...
                       <div class="editor-customizer-item__form__item__input__group feature">
                           ...
                           <div class="editor-customizer-item__form__item__input__group__content">
                               ...
                               <input
                                   ...
                                   onChange="${toggleFeatureInlineJs}"
                               />
                               <p>Turn On Feature</p>
                               </div>
            ...
            // Then we will generate the editor category tabs
            const editorTabsHTML = (() => {
               const categories = [
                  {
                     name: "Contents",
                     templateItems: [
                        ...(templateItem?.features || []),
                        ...(templateItem?.elementCustomizations || []),
                     ],
                  },
                  {
                     name: "Styles",
                     templateItems: templateItem?.cssCustomizations,
                  },
               ];
               const tabItems = categories.reduce((a, c) => {
                  const js = `{ const $el = this; const $elParent = $el.parentElement; const $elContent = $elParent.parentElement; const $formItems = $elContent.querySelectorAll('.editor-customizer-item__form .editor-customizer-item__form__item', ); $elParent.querySelectorAll('p').forEach(($item,i) => { $item?.classList?.[$item === $el ? 'add' : 'remove']('active'); }); $formItems.forEach(($formItem) => { const category = $formItem.getAttribute('data-category-type'); $formItem?.classList?.[category === '${c.name.toLowerCase()}' ? 'add' : 'remove']('active'); });}`;
                  a += `<p onclick="${js}" style="display: ${c.templateItems?.length ? "flex" : "none"}" class="editor-customizer-category__item ${c.name === "Styles" ? "active" : ""}">${c.name}</p>`;
                  return a;
               }, "");
               return `
                       <div class="editor-customizer-category">
                           ${tabItems}
                       </div>
                   `;
            })();
            ...
            const formItemFallbackHTML = `<p style="font-size: 15px; font-style: normal; text-align: center;">- No Settings -</p>`;
            const form = `
                       <div class="editor-customizer-header">
                           <i class="fa-solid fa-arrow-left editor-customizer-header__global" onclick="window.MembershipEditor.initializers.initializeGlobalContents()"></i>
                           <p class="editor-customizer-header__text">
                               ${globalName ? `${globalName}<br/>` : ""}
                               ${templateItem.label}
                           </p>
                           <div></div>
                       </div>
                       ...
                       <div class="editor-customizer-item__form">
                           <div class="editor-customizer-item__form__item" data-category-type="contents">
                              <p style="display: ${templateItem?.features?.length ? "block" : "none"}; margin-bottom: 5px; font-size: 12px;">Features</p>
                              ${featuresHTML || ""}
                              <p style="display: ${templateItem?.elementCustomizations?.length ? "block" : "none"}; margin-bottom: 5px; margin-top: 5px; font-size: 12px;">Content</p>
                              ${elementCustomizationHTML || ""}
                           </div>
                           <div class="editor-customizer-item__form__item active" data-category-type="styles">
                               ${cssCustomizationHtml || formItemFallbackHTML}
                           </div>
                       </div>
                   `;
         ...
         // This method will initialize the global contents in sidebar and render all the global elements
         initializeGlobalContents: () => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
            ...
            // Then we will retrieve the sidebar and its content container where we will inject the HTML
            const $sidebar = document.querySelector(".editor-customizer-sidebar");
            const $sidebarContent = $sidebar.querySelector(
               ".editor-customizer-sidebar__content",
            );
            ...
            const globalItemsHTML = activeTemplate?.global.reduce((a, c) => {
               ...
               const globalItemElements = c?.customizations?.reduce((ac, cc) => {
                  ...
                  ac += `
                         <div class="global-contents-item__item" onclick="window.MembershipEditor.initializers.initializeElementEditor('${cc.key}','${cc.elementSelector}', true, '${c.name}')">
               ...
               a += `
                       <div class="global-contents-item" style="display: ${this.isDesktop || (!this.isDesktop && c.showOnMobileEditor) ? "block" : "none"}">
                           <div class="global-contents-item__toggler" onClick="this.parentElement.classList.toggle('active')">
                               <p>${c.name}</p>
                               <i class="fa-solid fa-angle-right"></i>
                           </div>
                           <div class="global-contents-item__wrapper">${globalItemElements}</div>
                       </div>
                  `;
               return a;
            }, "");

            // Finally we will render the fully generated global contents into the sidebar content area
            $sidebarContent.innerHTML = `
                   <div class="global-contents">
                       <div class="global-contents__header">
                           <i onclick="window.MembershipEditor.actions.switchEditorMode(${!this.isDesktop})" class="fa-solid ${this.isDesktop ? "fa-mobile-screen" : "fa-desktop"} global-contents__header__mobile-switch"></i>
                           <p class="global-contents__header__text">Global</p>
                           <div class="global-contents__header__control">
                              <i onclick="window.MembershipEditor.actions.undoChanges()" class="fa-solid fa-rotate-left ${this.templateUndoStack?.length ? "" : "disabled"} undo"></i>
                              <i onclick="window.MembershipEditor.actions.resetTemplateToDefaultInCustomJs('.editor-customizer-sidebar')" class="fa-solid fa-arrows-rotate"></i>   
                           </div>
                       </div>
                       <div class="global-contents__additional-settings" onClick="window.MembershipEditor.initializers.initializeListOfEditablePages()">
                          <p>Switch Level</p>
                          <i class="fa-solid fa-angle-right"></i>
                       </div>
                       <div class="global-contents__additional-settings" onClick="window.MembershipEditor.initializers.initializeThemeSelector()">
                          <p>Switch Template</p>
                          <i class="fa-solid fa-angle-right"></i>
                       </div>
                        <div class="global-contents__additional-settings" onClick="window.MembershipEditor.initializers.initializeAdvanceSettings()">
                           <p>Advance Settings</p>
                           <i class="fa-solid fa-angle-right"></i>
                        </div>
                        <p class="global-contents__separator">Global Components</p>
                       ${globalItemsHTML}
                   </div>
               `;
         },

         // This method will initialize the advance settings in sidebar
         initializeAdvanceSettings: () => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
            ...
            // Then we will create the custom css html
            const customCssHTML = (() => {
               return `
                  <div class="advance-settings__customcss">
                     <p class="advance-settings__customcss__label">Custom Css</p>
                     <textarea name="custom-css" onchange="window.MembershipEditor.actions.updateTemplateCustomCss(this.value || '')">${activeTemplate?.customCss || ""}</textarea>
                  </div>
               `;
            })();

            // Then we will create the custom fonts list html
            const fontsListHTML = (() => {
               return `
                  <div class="advance-settings__fonts">
                     <p class="advance-settings__fonts__label">Custom Fonts</p>
                     <textarea name="customFonts" onchange="window.MembershipEditor.actions.updateTemplateCustomFonts(this.value || '')">${(activeTemplate?.customFonts || []).join(",\n")}</textarea>
                     <p class="advance-settings__fonts__info">ⓘ Import your font families in the Custom JS first. Then, list the font names below, separated by commas (e.g., Open Sans, Montserrat, Roboto), to populate the Font Family dropdown.</p>
                  </div>
               `;
            })();

            // Then we will create the updateTemplateThumbnailPlaceholder html
            const templateThumbnailPlaceholderHTML = (() => {
               return `
                  <div class="advance-settings__thumbnail-placeholder">
                     <p class="advance-settings__thumbnail-placeholder__label">Thumbnail Placeholder</p>
                     <div style="background-image: url('${activeTemplate?.placeholderThumbnail || ""}')" class="advance-settings__thumbnail-placeholder__preview"></div>
                     <input name="placeholder-thumbnail" type="text" onchange="window.MembershipEditor.actions.updateTemplateThumbnailPlaceholder(this.value || '')" value="${activeTemplate?.placeholderThumbnail || ""}" />
                     <p class="advance-settings__thumbnail-placeholder__info">ⓘ Changes will be reflected after saving or refreshing the page</p>
                   </div>
               `;
            })();
            ...
            $sidebarContent.innerHTML = `
                   <div class="theme-selector">
                       <div class="additional-settings-header">
                           <i class="fa-solid fa-arrow-left additional-settings-header__icon" onclick="window.MembershipEditor.initializers.initializeGlobalContents()"></i>
                           <p class="additional-settings-header__text">Advance Settings</p>
                           <div></div>
                       </div>
                       ${templateThumbnailPlaceholderHTML}
                       ${customCssHTML}
                       ${fontsListHTML}
                   </div>
               `;
         ...
         // This methid will intialize the page preview list selector
         initializeListOfEditablePages: async () => {
            // First we will retrieve the editable pages from membership preview getListOfEditablePages
            const listOfEditablePages =
               await this.$iframe.contentWindow?.MembershipPreview?.data?.getListOfEditablePages();
            ...
            // Then we will generate the list of editable pages html
            const listOfPagesHTML = listOfEditablePages.reduce((a, c) => {
               const clickAction = `window.MembershipEditor.actions.switchPage('${c.url}')`;
               a += `
                  <div onclick="${c.isActive ? "" : clickAction}" class="editable-pages__list__item">
                     <input ${c.isActive ? "checked" : ""} type="checkbox" style="pointer-events: none;" />
                     <p>${c.name}</p>
                  </div>
               `;
               return a;
            ...
            // Finally we will render the fully generated HTML into the sidebar content area
            $sidebarContent.innerHTML = `
                   <div class="editable-pages">
                       <div class="additional-settings-header">
                           <i class="fa-solid fa-arrow-left additional-settings-header__icon" onclick="window.MembershipEditor.initializers.initializeGlobalContents()"></i>
                           <p class="additional-settings-header__text">Switch Level</p>
                           <div></div>
                       </div>
                       <div class="editable-pages__list">${listOfPagesHTML}</div>
                   </div>
               `;
         },
         ...
         initializeThemeSelector: () => {
            ...
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const templates = previewIframeMembershipParser.templates;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            ...
            const themeHTML = (() => {
               const itemHTML = templates.reduce((a, c) => {
                  const controllerHTML = (() => {
                     if (activeTemplate.id === c.id) {
                        return `
                        ...
                        return `
                           <div class="theme-selector__list__item__controller">
                               <a href="#" onclick="window.MembershipEditor.actions.updateTemplateToProductsCustomJs('${c.id}', '.theme-selector__list')" class="theme-selector__list__item__controller__button">
               ...
               return `<div class="theme-selector__list">${itemHTML}</div>`;
            })();
            ...
            $sidebarContent.innerHTML = `
                   <div class="theme-selector">
                       <div class="additional-settings-header">
                           <i class="fa-solid fa-arrow-left additional-settings-header__icon" onclick="window.MembershipEditor.initializers.initializeGlobalContents()"></i>
                           <p class="additional-settings-header__text">Templates</p>
                           <div></div>
                       </div>
                       ${themeHTML}
                   </div>
      ...
      data = {
         getGoogleFonts: async () => {
            const storageName = `google-fonts`;
            ...
            return await new Promise((resolved, reject) => {
               const url = `https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyAHS80BtgSVvvCpN8iEMvVyKcOBJCVOCSM`;
               fetch(url, {
                  headers: {
      ...
      // Action module
      actions = {
         // This method save's current template to undoStack
         saveTemlplateSnapshotToUndoStack: () => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            ...
            // First we will clone the active template
            const clonedTemplateSchema = window._.cloneDeep(activeTemplate);
            const clonedActivePageOnTemplate = window._.cloneDeep(activePageOnTemplate);

            // Then we will push the active template to undo stack
            this.templateUndoStack.unshift({
               wholeSchema: clonedTemplateSchema,
               activePageOnTemplate: clonedActivePageOnTemplate,
            });

            // Then we will keep only the latest 5 snapshots in the undo stack
            this.templateUndoStack = this.templateUndoStack;

            // Finally we will enable the undo button
            document.querySelector(".undo")?.classList?.remove("disabled");
         },

         // This method is responsible for undoing the latest template change from the undo stack
         undoChanges: () => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            ...
            // Then we will retrieve and remove the latest template snapshot from the undo stack
            const undoTemplate = this.templateUndoStack.shift();

            // Then we will disable the undo button if there are no more template snapshots in the undo stack
            if (!this.templateUndoStack.length) {
               document.querySelector(".undo")?.classList?.add("disabled");
            }

            // Then we will stop the undo process if there is no template snapshot to restore
            if (!undoTemplate) return;

            // Then we will restore the active template using the retrieved template snapshot
            this.$iframe.contentWindow.MembershipParser.activeTemplate =
               undoTemplate.wholeSchema;
            this.$iframe.contentWindow.MembershipParser.activePageOnTemplate =
               undoTemplate.activePageOnTemplate;

            // Finally we will sync the previou schanges
            this.$iframe.contentWindow.MembershipParser.initializers.initSyncConfig(true);
         },
         ...
         toggleTemplateFeature: (
            ...
            // Then we will save the current template snapshot to undoStack
            this.actions.saveTemlplateSnapshotToUndoStack();

            // Then we will initialize placeholders for the items we need to find
            let templateItem = null;
            let featureItem = null;
            ...
            const toggleFeature = (
               ...
               if (isTurnedOn) {
                  ...
                  this.$iframe.contentDocument.body.insertAdjacentHTML(
                     "beforeend",
                     `
                           <style id="${templateItemKey}-${featureKey}">
                               ${featureItem.css(featureItem.customizations)}
                  ...
                  const scriptTag = this.$iframe.contentDocument.createElement("script");
                  scriptTag.id = `${templateItemKey}-${featureKey}`;
                  scriptTag.innerHTML = featureItem.js(featureItem.customizations);
                  this.$iframe.contentDocument.body.append(scriptTag);
               } else {
            ...
            if (!global.featureKey) {
               ...
               templateItem = activePageOnTemplate.find(
                  (item) => item.key === normal.templateItemKey,
               );
               featureItem = templateItem.features.find(
                  (fI) => fI.key === normal.featureKey,
               ...
               activePageOnTemplate.forEach((item) => {
               ...
               activeTemplate.global.forEach((item) => {
         ...
         updateTemplateCustomizations: (
            normal = { key: "", property: "", value: "" },
            global = { name: "", key: "", property: "", value: "" },
         ) => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            ...
            // Then if a normal key is provided, we will find the specific item on the active page and update its CSS value
            if (normal?.key) {
               activePageOnTemplate.forEach((item) => {
            ...
            previewIframeMembershipParser.actions.syncTemplateCssCustomizations();
         },

         // This method updates a specific customization for the activePageOnTemplate's element
         updateTemplateElementCustomizations: (
            normal = { key: "", type: "attribute", target: "", value: "" },
            global = {
               name: "",
               key: "",
               type: "attribute",
            ...
            /**
             * Then we will locate the element customization on the active page by matching:
             * - the element key
                  ...
                  if (item.name === global.name) {
                     item.customizations.forEach((customizationItem) => {
                        if (customizationItem.key === global.key) {
                           customizationItem.elementCustomizations.forEach(
                              (elementCustomizationI) => {
                                 if (
                                    elementCustomizationI.type === global.type &&
                                    elementCustomizationI.target === global.target
                                 ) {
             ...
             */
            previewIframeMembershipParser.actions.syncTemplateElementsCustomization();
         },
         ...
         updateTemplateFeatureCustomizations: (
            ...
            // Then if a normal feature key is provided, we will traverse the active page to find and update the specific feature customization while checking if the feature is active
            if (normal.featureKey) {
               ...
               if (isTurnedOn) {
                  previewIframeMembershipParser.actions.syncTemplateFeatureCustomizations(
                     {
                           ...
                           cItem.features.forEach((fItem) => {
                              if (fItem.key === global.featureKey) {
                                 fItem.customizations.forEach((fcItem) => {
                                    if (
                                       fcItem.property === global.customizationProperty
                                    ) {
                                       isTurnedOn = fItem.isTurnedOn;
         ...
         // This method updates the template's custom css
         updateTemplateCustomCss: (customCss = "") => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            ...
            // First we will update the active template's custom css
            activeTemplate["customCss"] = customCss;

            // Finally we will sync the updated custom CSS value with the live preview
            previewIframeMembershipParser.actions.syncTemplateCustomCss();
         },

         // This method updates the template's fonts
         updateTemplateCustomFonts: (stringedFonts = "") => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            ...
            // First Split by comma and trim whitespace from each name
            const formattedFontsToArray = stringedFonts
               ?.split(",")
               ?.map((font) => font.trim())
               ?.filter((font) => font.length > 0);

            // Finally, update the active template custom fonts with the clean array
            activeTemplate.customFonts = formattedFontsToArray;
         },

         // This method updates the template's placeholderThumbnail
         updateTemplateThumbnailPlaceholder: (newThumbnail = "") => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            ...
            // Then we will update the background image url of the thumbnail placeholder previewer
            document.querySelector(
               ".advance-settings__thumbnail-placeholder__preview",
            ).style.backgroundImage = `url(${newThumbnail})`;

            // Finally, update the active template placeholderThumbnail
            activeTemplate.placeholderThumbnail = newThumbnail;
         },

         // This method pushes a new font into the template's googleFontsUsed
         pushFontGoogleFontsUsed: (fontName = "") => {
            // First we will retrieve the preview iframe MembershipParser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            const activeTemplateGoogleFontsUsed = activeTemplate.googleFontsUsed;

            // Then we will save the current template snapshot to undoStack
            this.actions.saveTemlplateSnapshotToUndoStack();

            // Then we will check if the passed font name already exists, if it does then we will not proceed
            if (activeTemplateGoogleFontsUsed.includes(fontName?.trim())) return;

            // Then we will push the passed font name into activeTemplateGoogleFontsUsed
            activeTemplateGoogleFontsUsed.push(fontName?.trim());

            // Finally we will sync the template's Google Fonts used
            previewIframeMembershipParser.actions.syncTemplateGoogleFontsUsed();
         },

         // This method is responsible for saving the user's edits inside the current product custom js in ghl
         saveEditsToProductsCustomJs: async (seamlessUpdate = false) => {
            // First we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
               previewIframeMembershipParser.activePageOnTemplate;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            const activeTemplatesConfig =
               this.$iframe.contentWindow.activeTemplatesConfig;

            // Then we will retrieve the authentication token and extract the location and product IDs from the URL
            ...
            if (auth?.tokenId) {
               try {
                  ...
                  let updatedActiveTemplatesConfig = activeTemplatesConfig || [];
                  ...
                  updatedActiveTemplatesConfig = updatedActiveTemplatesConfig.filter(
                     (tem) => tem.id !== activeTemplate.id,
                  );
                  updatedActiveTemplatesConfig.push(activeTemplate);
                  ...
                  this.$iframe.contentWindow.savedTemplatesFileInfo = fileData;
                  ...
                  await fetch(url, {
                     ...
                     priority: "high",
                     body: JSON.stringify({
                        customJs: `window.savedTemplatesFileInfo = ${JSON.stringify(fileData)}`,
                     }),
                     redirect: "follow",
                  });

                  // Then we will clear the undo stack
                  this.templateUndoStack = [];
                  document.querySelector(".undo")?.classList?.add("disabled");

                  // Then we will reload the preview iframe
                  ...
                  alert(
                     "❌ Oops! Something went wrong while saving. Try refreshing the page or contact support.",
                  );
                  console.error(err);
               }
            } else {
         ...
         updateTemplateToProductsCustomJs: async (
            templateId = "",
            selectorToToggle = "",
         ) => {
            ...
            if (
               !confirm(
                  "Do you want to proceed? Please save your changes before switching templates to avoid losing them.",
               )
            )
               return;

            // Then we will retrieve the preview iframe membership parser and the necessary variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
               previewIframeMembershipParser.activePageOnTemplate;
            ...
            if (auth?.tokenId) {
               try {
                  // First we will save the current changes of the current template
                  await this.actions.saveEditsToProductsCustomJs(true);

                  // Then we will toggle the selector to disabled state
                  if (selectorToToggle) {
                     document.querySelector(selectorToToggle).style.cssText =
                        "opacity: .5; pointer-events: none;";
                  }

                  // Then we will locate the selected template metadata based on the provided template id
                  ...
                  // Finally we will show a success message and reload the preview iframe
         ...
         // This method is responsible for restoring the user's current template to its default configuration
         resetTemplateToDefaultInCustomJs: async (selectorToToggle = "") => {
            // First we will confirm the user's intent to restore the current template to default
            if (
               !confirm(
                  "Do you want to proceed with restoring the current template to default?",
               )
            )
               return;

            // Then we will retrieve the preview iframe membership parser and the necessary template variables
            const previewIframeMembershipParser =
               this.$iframe.contentWindow.MembershipParser;
            const activePageOnTemplate =
               previewIframeMembershipParser.activePageOnTemplate;
            const originalTemplateCustomizationSchema =
               previewIframeMembershipParser.originalTemplateCustomizationSchema;
            const activeTemplate = previewIframeMembershipParser.activeTemplate;
            const activeTemplatesConfig =
               this.$iframe.contentWindow.activeTemplatesConfig;

            // Then we will retrieve the authentication token and extract the location and product IDs from the current auth context
            const auth = await this.utils.getAuth();
            const locationId = auth?.locationId;
            const productId = auth?.productId;

            // Then we will build the product service endpoint used to persist the restored template configuration into the product custom JS
            const url = `https://services.leadconnectorhq.com/membership/locations/${locationId}/products/${productId}`;

            // Finally if a valid token exists, we will restore the active template to its original default schema and save it
            if (auth?.tokenId) {
               try {
                  // First we will toggle the selector to disabled state while the restore process is running
                  document.querySelector(selectorToToggle).style.cssText =
                     "opacity: .5; pointer-events: none;";
                  ...
                  // Then we will replace the currently active template with the original default template customization schema
                  updatedActiveTemplatesConfig.forEach((template, templateIndex) => {
                     if (template.id === activeTemplate.id) {
                        updatedActiveTemplatesConfig[templateIndex] = {
                           isActive: true,
                           ...originalTemplateCustomizationSchema,
                        };
                     }
                  });

                  // Then we will stringify the updated template configuration while converting functions into strings for safe transport/storage
                  const stringifiedTemplateData = JSON.stringify(
                     updatedActiveTemplatesConfig,
                     (key, value) => {
                        if (typeof value === "function") {
                  ...
                  // Then we will upload the restored template configuration to GHL and include function rehydration logic for when it is loaded again
                  const fileData = await this.actions.uploadTextToGHL(
                     `var s = ${stringifiedTemplateData}; window.activeTemplatesConfig = JSON.parse(JSON.stringify(s), (key, value) => { if (typeof value === "string") { const isFunction = value.startsWith("function") || value.startsWith("(customizations = []) =>") || value.startsWith("(e=[])=>"); if (isFunction) { try { return new Function("return " + value)(); } catch (err) { console.error("Error reviving function for key:", key, err); return value; } } } return value;});`,
                     `${productId}.txt`,
                  );
                  ...
                  // Then we will attempt to update the product configuration by saving the uploaded template file reference into customJs
                  await fetch(url, {
                     method: "PUT",
                     headers: {
                        "authority": "services.leadconnectorhq.com",
                  ...
                  // Finally we will show a success message and reload the preview iframe
                  alert("✅ Done! Restored to default.");
                  this.$iframe.src = this.$iframe.src;
               } catch (err) {
                  // Finally we will notify the user and log the error for debugging if restoring the template fails for any reason
                  alert(
                     "❌ Oops! Something went wrong while saving. Try refreshing the page or contact support.",
                  );
                  console.error(err);
               } finally {
                  // Finally we will restore the selector to enabled state
                  document.querySelector(selectorToToggle).style.cssText =
                     "opacity: 1; pointer-events: all;";
               }
            } else {
               // Finally we will block the restore action and instruct the user to refresh or contact support when no valid token is available
               alert("❌ Invalid token. Please refresh the page or contact support.");
            }
         },

         // This function uploads image to ghl media
         uploadTextToGHL: async (textContent = "", fileName = "", parentFolder = "") => {
            const auth = await this.utils.getAuth();
            const locationId = auth?.locationId;
            ...
            let isError = false;
            try {
               // First  we will retrieve the preview iframe membership
               const previewIframeMembershipSavedTemplatesFileInfo =
                  this.$iframe.contentWindow.savedTemplatesFileInfo;

               // Then we will upload the new configuration
               ...
               const validateResponse = await fetch(
                  "https://services.leadconnectorhq.com/medias/files/verify",
                  {
                     method: "POST",
                     headers: {
                        "Version": "2021-07-28",
               ...
               // Then we will remove the previous configuration
               fetch("https://services.leadconnectorhq.com/medias/delete-files", {
                  method: "PUT",
                  headers: {
                     "Version": "2021-07-28",
                     "Source": "WEB_USER",
                  ...
                  priority: "high",
                  body: JSON.stringify({
                     altId: String(previewIframeMembershipSavedTemplatesFileInfo?.altId),
                     altType: previewIframeMembershipSavedTemplatesFileInfo?.altType,
                     mode: "public",
                     status: "trashed",
                     filesToBeDeleted: [
                        {
                           _id: String(previewIframeMembershipSavedTemplatesFileInfo?.id),
                           altId: String(
                              previewIframeMembershipSavedTemplatesFileInfo?.altId,
                           ),
                           altType:
                              previewIframeMembershipSavedTemplatesFileInfo?.altType,
                           parentId: "",
                           name: previewIframeMembershipSavedTemplatesFileInfo?.name,
                           url: previewIframeMembershipSavedTemplatesFileInfo?.url,
                           size: previewIframeMembershipSavedTemplatesFileInfo?.size,
                           contentType: "text/plain",
                           isPrivate: false,
                        },
                     ],
               ...
               // Finally return the new file information
               return {
                  id: validateJSON._id,
                  altId: validateJSON.altId,
                  altType: validateJSON.altType,
                  name: validateJSON.name,
                  url: validateJSON.url,
                  size: validateJSON.size,
               };
            } catch (err) {
               isError = true;
               alert("Something went wrong, please reload or try again.");
            }
         },

         // This method toggles the editor view between desktop and mobile modes.
         switchEditorMode: async (isDesktop = true) => {
            // First we will ask the user to confirm their decision to open the mobile customizer
            const isConfirm = confirm(
               `Please save your changes before switching to another view. If you have already saved, you may continue; otherwise, we advise saving now so your changes are not lost.`,
            );

            // Then we will check the user's decision and if they did not agree then we will not proceed
            if (!isConfirm) return;

            // Then we will update the iframe
            this.isDesktop = isDesktop;
            this.$iframe.style.width = isDesktop ? "100%" : "500px";
            this.$iframe.contentDocument.body.style.display = "none";
            setTimeout(() => {
            ...
            // Finally we will add a loading indicator inside the sidebar editor
            document.querySelector(".editor-customizer-sidebar").insertAdjacentHTML(
               "beforeend",
               `
               <div style="padding: 24px 16px;background: #f9f9f9;border-radius: 8px;border: 1px solid #eee;text-align: center;font-family: sans-serif;position: absolute;top: 0;height: 100%;z-index: 99999999;display: flex;flex-direction: column;align-items: center;">
                  <div style="margin: 0 auto 16px auto; width: 24px; height: 24px; border: 3px solid #ddd; border-top: 3px solid #000; border-radius: 50%; animation: spin 0.8s linear infinite;"></div>
                  <style>@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }</style>
                  <h3 style="margin: 0 0 8px 0; color: #000; font-size: 18px; font-weight: 600;">Changing View</h3>
                  <p style="color: #444; font-size: 14px; line-height: 1.5; margin: 0;">
                      Please wait while we are changing the view...
                  </p>
               </div>
            `,
            );
         ...
         // This method update the page of the preview url with the passed page url.
         switchPage: async (page = "") => {
            // First we will ask the user to confirm their decision to switch page
            const isConfirm = confirm(
               `Please save your changes before switching to another page. If you have already saved, you may continue; otherwise, we advise saving now so your changes are not lost.`,
            );
            ...
            document.querySelector(".editor-customizer-sidebar").insertAdjacentHTML(
               ...
               <div style="padding: 24px 16px;background: #f9f9f9;border-radius: 8px;border: 1px solid #eee;text-align: center;font-family: sans-serif;position: absolute;top: 0;height: 100%;z-index: 99999999;display: flex;flex-direction: column;align-items: center;">
                  <div style="margin: 0 auto 16px auto; width: 24px; height: 24px; border: 3px solid #ddd; border-top: 3px solid #000; border-radius: 50%; animation: spin 0.8s linear infinite;"></div>
                  <style>@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }</style>
                  <h3 style="margin: 0 0 8px 0; color: #000; font-size: 18px; font-weight: 600;">Switching Page</h3>
                  <p style="color: #444; font-size: 14px; line-height: 1.5; margin: 0;">
                      Please wait while we are switching the page...
                  </p>
               </div>
            `,
            );
      ...
      // Widgets module
      widgets = {
         popup: (content = "", isFit = false, overFlow = "hidden") => {
            document.querySelector("[data-widget-popup-root]")?.remove();
            const popupHTML = `
               <div data-widget-popup-root>
                  <style>
                     .widget-popup {
                        position: fixed;
                        inset: 0;
                     ...
                     .widget-popup__panel {
                        position: relative;
                        z-index: 1;
                        width: ${isFit ? "fit-content" : "min(420px, 100%)"};
                        min-height: ${isFit ? "fit-content" : "50vh"};
                  ...
                  <div class="widget-popup" data-widget-popup role="dialog" aria-modal="true">
                     <button class="widget-popup__backdrop" type="button" aria-label="Close popup" onclick="this.closest('[data-widget-popup-root]').remove()"></button>
                     <div class="widget-popup__panel">
                        <button class="widget-popup__close" type="button" aria-label="Close popup" onclick="this.closest('[data-widget-popup-root]').remove()">
                           <i class="fa-solid fa-xmark"></i>
                        </button>
                        <div class="widget-popup__body">${content}</div>
                     </div>
                  </div>
               </div>
            `;
            document.body.insertAdjacentHTML("beforeend", popupHTML);
            return document.querySelector("[data-widget-popup-root]");
         },
         multiInput: (templateKey, property, value = "", onChange = () => {}) => {
            ...
            const listenerFunction = (e) => {
               ...
               if ($targetElement) {
                  ...
                  const widgetTemplateKey =
                     $targetElement.getAttribute("data-template-key");
                  ...
                  if (widgetTemplateKey === templateKey && widgetProperty === property) {
                     ...
                     if (inputSide === "all") {
                        Array.from($targetElement.querySelectorAll("change"))
                     ...
                     const finalValue = ["top", "right", "bottom", "left"].reduce(
                        (a, c) => {
                           const value =
                              $targetElement.querySelector(`input[data-side=${c}]`)
                                 ?.value || 0;
                           a += `${value}px `;
                           return a;
                        },
            ...
            if (listenerId in window?._multiInputListeners) {
               window.removeEventListener(
                  "change",
                  window._multiInputListeners[listenerId],
               );
            }
            window.addEventListener("change", listenerFunction);
         ...
         input: (
            ...
            const listenerFunction = (e) => {
               ...
               if (
                  $targetElement.classList.contains(`editor-customizer-form__item__input`)
               ) {
                  const widgetTemplateKey =
                     $targetElement.getAttribute("data-template-key");
                  const widgetProperty = $targetElement.getAttribute(
            ...
            if (listenerId in window?._input) {
               window.removeEventListener("change", window._input[listenerId]);
            }
            window.addEventListener("change", listenerFunction);
            ...
            if (isTextArea) {
               setTimeout(() => {
                  // We will retrieve the Google Fonts and process them along with the custom fonts
                  this.data.getGoogleFonts().then((gFontRes) => {
                     document.querySelectorAll(".rich-text").forEach(($richText) => {
                        ...
                        tinymce.init({
                           ...
                           toolbar:
                              "code | bold italic | bullist numlist | removeformat | undo redo | fontwidget",
                           content_css: "https://googleapis.com",
                           height: 300,
                           setup: (editor) => {
                              // On Change
                              editor.on("change", function () {
                                 ...
                                 const value = originalTextarea.value.replace(
                                    /^<p>(.*)<\/p>$/s,
                                    "$1",
                                 );
                              ...
                              // Font Selector
                              editor.ui.registry.addButton("fontwidget", {
                                 text: "Font Family",
                                 onAction: (api) => {
                                    const node = editor.selection.getNode();
                                    const fontFamily = editor.dom
                                       .getStyle(node, "font-family")
                                       ?.replace(/^['"]|['"]$/g, "");
                                    const popup = this.widgets.popup(
                                       this.widgets.fontSelect(
                                          templateKey,
                                          property,
                                          fontFamily,
                                          "tinymce",
                                          ...
                                          (font) => {
                                             ...
                                             if (font.type === "google") {
                                                this.actions.pushFontGoogleFontsUsed(
                                                   font.name,
                                                );
                                             }
                                          },
            ...
            return isTextArea
               ...
               : `
                     ...
                     data-template-key=${templateKey}
                     data-template-property=${property}
                     type="${type === "color" ? "text" : type || "text"}"
                     value="${value}"
         ...
         select: (
            ...
            // Finally return the actual HTML for the widget
            const optionsHTML = options.reduce((a, c) => {
               const isSelected = c === value;
               a += `<option value="${c}" ${isSelected ? "selected" : ""}>${c?.toUpperCase()}</option>`;
               return a;
            }, "");
            return `
               <select
                 ...
                 data-template-property=${property}
                 id="${templateKey}${property}"
                 class="editor-customizer-form__item__input select"
               >
         ...
         fontSelect: (
            ...
            // First we will create a function that will be responsible for showing and filtering the font options
            const showFontSelectOptions = (filterText = "") => {
               // We will retrieve the Google Fonts and process them along with the custom fonts
               this.data.getGoogleFonts().then((gFontRes) => {
                  // First we will retrieve the option list
                  const $selectList = document.querySelector(
                     `.${templateKey}${property}-list`,
                  );

                  // Then we will generate the Google Fonts options HTML
                  const gFontsOptionsHTML = (() => {
                     // First we will retrieve the fonts
                     let gFonts = [];
                     if (!filterText) {
                        function getInitialFonts(fonts) {
                           return "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                              .split("")
                              .flatMap((l) =>
                                 fonts.filter((f) => f.family.startsWith(l)).slice(0, 5),
                              );
                        }
                        gFonts = getInitialFonts(gFontRes?.items);
                     } else {
                        gFonts = gFontRes?.items
                           ?.filter((gFont) =>
                              gFont?.family
                                 ?.toLowerCase()
                     ...
                     // Then we will insert the Google Font families in chunks so that users will see the preview of each font
                     (() => {
                        // First we will create a variable that will hold all of the chunks
                        const fontChunks = [];

                        // Then we will slice the fonts array into groups of 10 and push each group into the fontChunks array
                        for (let i = 0; i < gFonts.length; i += 10) {
                           fontChunks.push(gFonts?.slice(i, i + 10));
                        }

                        // Finally we will iterate over all the fontChunks and conditionally insert the font family using @import
                        fontChunks.forEach((chunk) => {
                           // First we will filter out fonts that have already been injected to avoid duplicate requests
                           const filteredChunk = chunk?.filter(
                              (f) => !this.loadedGoogleFontsPreview.includes(f.family),
                           );

                           // Then we will skip this chunk entirely if all fonts have already been loaded
                           if (!filteredChunk.length) return;

                           // Then we will build the Google Fonts URL by mapping each font family to its full axis string
                           const googleFontsUsed = filteredChunk
                              ?.map(
                                 (f) =>
                                    `${f.family.replace(/ /g, "+")}:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900`,
                              )
                              .join("&family=");
                           const googleFontsUsedStyleHTML = `
                              <style class="bm-editor-fonts-preview">
                                 @import url('https://fonts.googleapis.com/css2?family=${googleFontsUsed}&display=swap');
                              </style>
                           `;

                           // Then we will insert the style tag into the DOM so the fonts are available for preview
                           document.body.insertAdjacentHTML(
                              "beforeend",
                              `${googleFontsUsedStyleHTML}`,
                           );

                           // Finally we will mark each font as loaded so it is never injected again
                           chunk.forEach((e) => {
                              this.loadedGoogleFontsPreview.push(e.family);
                           });
                        });
                     })();

                     // Then we will generate the HTML for each font option with its font family applied for preview
                     const optionsHTML = gFonts.reduce((a, c) => {
                        a += `<li style="font-family: ${c?.family}" class="widget-font-select__item" onmousedown="(function(){const $i = document.getElementById('${templateKey}${property}');$i.value = '${c?.family}';$i.setAttribute('data-type', 'google');$i.dispatchEvent(new Event('input', { bubbles: true }));})();">${c?.family}</li>`;
                        return a;
                     }, ``);

                     // Finally we will return the options HTML wrapped in a label, or an empty string if there are no results
                     return optionsHTML ? `<p>Google Fonts</p>${optionsHTML}` : "";
                  })();

                  // Then we will generate the custom fonts options HTML
                  const customFontsOptionsHTML = (() => {
                     const optionsHTML =
                        this.$iframe.contentWindow.MembershipParser?.activeTemplate[
                           "customFonts"
                        ]
                           ...
                           ?.reduce((a, c) => {
                              a += `<li class="widget-font-select__item" onmousedown="(function(){const $i = document.getElementById('${templateKey}${property}');$i.value = '${c}';$i.setAttribute('data-type', 'custom');$i.dispatchEvent(new Event('input', { bubbles: true }));})();">${c}</li>`;
                              return a;
                           }, ``);
                     return optionsHTML ? `<p>Custom Fonts</p>${optionsHTML}` : "";
                  })();

                  // Finally we will replace the select list inner HTML with the new filtered options
                  $selectList.innerHTML = `
                     <li class="widget-font-select__item" onmousedown="(function(){const $i = document.getElementById('${templateKey}${property}');$i.value = '';$i.setAttribute('data-type', 'custom');$i.dispatchEvent(new Event('input', { bubbles: true }));})();">Select</li>
            ...
            const listenerFunction = (e) => {
               const $targetElement = e.target;
               // First we will listen for the select option list input change and filter the options
               if (
                  $targetElement.classList.contains(`${templateKey}${property}-search`)
               ) {
                  showFontSelectOptions(e.target.value);
               }

               // Finally we will listen for changes in the hidden input inside the select where we store the selected option value
               if (
                  $targetElement.classList.contains(`editor-customizer-form__item__input`)
               ) {
                  const widgetTemplateKey =
                  ...
                  if (widgetTemplateKey === templateKey && widgetProperty === property) {
                     // First we will retrieve the data type e.g(google, custom)
                     const type = e.target.getAttribute("data-type");

                     // Then we will update the value and font family of the search input
                     const $filterInput = document.querySelector(
                        `.${templateKey}${property}-search`,
                     );
                     $filterInput.value = e.target.value;
                     $filterInput.style.fontFamily = e.target.value;

                     // Finally we will invoke the onChange callback
                     onChange?.({
                        name: e.target.value,
                        type,
                     });
            ...
            // Then we will initialize the font select options
            showFontSelectOptions();

            // Finally we will return the font selection HTML
            return `
               <div class="widget-font-select ${templateKey}${property}-select">
                   <input type="text" value="${value}" style="font-family: ${value}" class="widget-font-select__input ${templateKey}${property}-search" placeholder="${value || `Search fonts...`}" autocomplete="off">
                   <ul class="widget-font-select__list ${templateKey}${property}-list">
                       <li class="widget-font-select__item" data-value="">Loading...</li>
                   </ul>
                   <input type="hidden" data-template-key=${templateKey} data-template-property=${property} id="${templateKey}${property}" name="font_family" class="widget-font-select__value editor-customizer-form__item__input" >
               </div>
            `;
         },
      };
      ...
      utils = {
         ...
         // Then method waits for the element and return it
         ...
         // This helper method retrieves the snapshot of an element
   ...
   if (!window.MembershipParser) {
      window.MembershipParser = new MembershipParser();
   }

   if (!window.MembershipEditor) {
      const membershipEditorInterval = setInterval(() => {
         if (sessionStorage?.is_preview) {
            clearInterval(membershipEditorInterval);
            window.MembershipEditor = new MembershipEditor();
         }
      }, 500);
      setTimeout(() => {
         clearInterval(membershipEditorInterval);
